...
\runsubsection{Quantitative Researcher And Developer}
\descript{| Abu Dhabi Investment Authority (ADIA)}
\location{ July 2023 - Now | Abu Dhabi, United Arab Emirates}
ADIA is one of the largest sovereign wealth funds in the world. I work in the QRD team whose objective is to develop and implement investment strategies while advancing work to unify its data platform and enhance its engineering infrastructure. My main tasks are to: $ $
\vspace{0.1cm}
\begin{tightemize}
	\item[\diamond] Conduct research and deploy advanced pipelines for processing textual data in systematic investment strategies.  
	\item[\diamond] Leverage \textbf{NLP} and \textbf{LLMs} to enhance model training and feature extraction processes.  
	\item[\diamond] Apply data-driven insights to support Market Neutral and Directional strategies, both systematic and semi-systematic approaches.
\end{tightemize}
...
\descript{| Talkwalker}
\location{ Mai 2021 - June 2023 | Luxembourg, Luxembourg}
...
\begin{minipage}[t]{0.39\textwidth}
	...
	\begin{tightemize}
		...
		\item[\diamond] Basics knowledge: \textbf{Java} $\diamond$ \textbf{Scala} $\diamond$ \textbf{Kafka} $\diamond$ \textbf{MongoDB} $\diamond$ \textbf{Docker}
	\end{tightemize}
